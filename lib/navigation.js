const baseNavigationItems = [
  ...
  { id: "4", title: "Items List", url: "/items", iconKey: "tags" },
  { id: "5", title: "Purchase", url: "/purchase", iconKey: "cart" },
  { id: "6", title: "Inventory", url: "/inventory", iconKey: "shop" },
  { id: "7", title: "Sales", url: "/sales", iconKey: "shopping" },
  { id: "12", title: "Sale Returns", url: "/sale-returns", iconKey: "rollback" },
  { id: "11", title: "Quotation", url: "/quotation/create", iconKey: "fileText" },
  { id: "8", title: "Ledger", url: "/ledger", iconKey: "accountBook" },
  { id: "9", title: "Reports", url: "/reports", iconKey: "barChart" },
  { id: "10", title: "Cheques", url: "/cheques", iconKey: "money" },
  { id: "15", title: "Billing", url: "/billing", iconKey: "creditCard" },
];

const adminNavigationItems = [
  { id: "13", title: "Users", url: "/users", iconKey: "userAdd" },
  { id: "16", title: "Payments", url: "/payment-requests", iconKey: "audit" },
];
