...
const TERMS_TITLE = "Terms of Service - TSO by TRS";
const TERMS_DESCRIPTION =
  "Read the terms governing use of the TSO by TRS inventory management and accounting platform.";

const SECTIONS = [
  {
    title: "Acceptance of Terms",
    content:
      "By accessing or using the TSO by TRS platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any part of these terms, you are prohibited from using the service. These terms apply to all users, including free trial users and paid subscribers.",
  },
  {
    title: "Description of Service",
    content:
      "TSO by TRS is a cloud-based inventory and accounting management platform designed for small and medium-sized businesses (SMBs). The service includes real-time inventory tracking, purchase order management, sales management, double-entry ledger accounting, reporting and analytics, and related features as described on our website. Features may be added, modified, or removed at our discretion.",
  },
  {
  ...
  },
  {
    ...
    content:
      "You agree not to use TSO by TRS for any unlawful purpose or in violation of these terms. Prohibited activities include: attempting to gain unauthorized access to any part of the service or its infrastructure; uploading or transmitting malicious code, viruses, or any software intended to disrupt the service; reselling or sublicensing access to TSO by TRS without express written permission; scraping, crawling, or harvesting data from the platform in an automated manner; using the service to store or transmit content that is illegal, defamatory, or infringes third-party rights.",
  },
  {
    title: "Intellectual Property",
    content:
      "TSO by TRS, its name, logo, product design, underlying technology, and all associated content are the intellectual property of TSO by TRS and are protected by applicable copyright, trademark, and other laws. You are granted a limited, non-exclusive, non-transferable license to use the service for your internal business purposes. Your data — including inventory records, customer lists, and financial entries — remains your property at all times.",
  },
  {
    title: "Data and Privacy",
    content:
      "Your use of TSO by TRS involves the collection and processing of personal and business data. How we handle that data is governed by our Privacy Policy, which is incorporated by reference into these Terms of Service. By using the service, you consent to the data practices described in the Privacy Policy.",
  },
  {
    title: "Termination",
    content:
  ...
  },
  {
    ...
    content:
      "To the maximum extent permitted by applicable law, TSO by TRS shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including lost profits, loss of data, or business interruption arising from your use of or inability to use the service. In no event shall our aggregate liability exceed the total amount you paid to TSO by TRS in the three (3) months immediately preceding the event giving rise to the claim.",
  },
  {
    title: "Governing Law",
    content:
      "These Terms of Service are governed by and construed in accordance with the laws of Pakistan, without regard to conflict of law principles. Any disputes arising out of or relating to these terms or your use of TSO by TRS shall be resolved exclusively in the courts of Karachi, Pakistan. By using the service, you consent to the personal jurisdiction of such courts.",
  },
  {
    title: "Contact",
    content:
        ...
        <main style={{ maxWidth: 760, margin: "0 auto", padding: "clamp(80px, 10vw, 120px) 24px 100px" }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p style={{ fontSize: 16, color: "var(--ink-2)", lineHeight: 1.7, marginBottom: 48 }}>
              Effective date: January 1, 2026. Please read these terms carefully before using TSO by TRS. They govern
